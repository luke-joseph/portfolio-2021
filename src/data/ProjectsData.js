export const ProjectsData = [
  {
    ...
    logos: [
        {
          name: 'php',
          src: '/img/php-logo-basic.svg',
          additionalClasses: 'w-8 mr-2'
        },
        {
          name: 'laravel',
          src: '/img/laravel-logo.png',
          additionalClasses: 'w-6 mr-3'
        },
        {
          name: 'vue',
          src: '/img/vue-logo.png',
          additionalClasses: 'w-5 mr-2'
        },
        {
          name: 'tailwind',
          src: '/img/tailwindcss-logo.jpg',
          additionalClasses: 'w-7'
        }
      ],
      buttons: [
        {
          name: 'WEBSITE',
          url: 'https://trackwire.io/features',
          additionalClasses: '',
        }
      ],
  ...
  },
  {
    ...
    logos: [
      ...
      buttons: [
        {
          name: 'WEBSITE',
          url: 'https://moviesdb.lukejoseph.dev/',
          additionalClasses: '',
        },
        {
          name: 'GITHUB',
          url: 'https://github.com/luke-joseph/movies-library',
  ...
  },
  {
    ...
    logos: [
      ...
      buttons: [
        {
          name: 'WEBSITE',
          url: 'https://scarymaze.lukejoseph.dev/',
          additionalClasses: '',
        },
        {
          name: 'GITHUB',
          url: 'https://github.com/luke-joseph/maze',
          additionalClasses: 'ml-3',
        }
      ],
